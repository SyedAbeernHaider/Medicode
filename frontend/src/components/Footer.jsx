    ...
    <footer className="bg-blue-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-blue-200 mb-4">
              Providing quality healthcare consultations and services to improve your wellbeing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-blue-200">123 Medical Avenue, Healthcare City</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 mt-0.5 text-blue-300"
              ...
              <li className="flex items-start">
                ...
                <span className="text-blue-200">contact@mediconsult.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-blue-800 mt-8 pt-6">
          <p className="text-center text-blue-300">© {new Date().getFullYear()} MediConsult. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
