...
import { FiCalendar, FiPhone, FiUser, FiAlertCircle, FiCheckCircle, FiClock } from 'react-icons/fi';
...
const Dashboard = () => {
  ...
  // Removed handleLogout as it's now handled in AdminNavbar
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900">Consultation Dashboard</h1>
          </header>

          <main className="bg-white shadow rounded-lg p-4 sm:p-6">
            {/* Stats */}
